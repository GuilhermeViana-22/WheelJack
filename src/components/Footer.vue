<template>
  ...
  <li><a href="#"><i class="fab fa-instagram"></i></a></li>
        ...
        <!-- Certificates and payment methods -->
        ...
        <div class="copyright">
          <p>© 2025 Arte Nobre Service. Todos os direitos reservados.</p>
          <p>Desenvolvido por <span class="developer">Guilherme Viana</span></p>
        </div>
      </div>
    </footer>
  </template>
